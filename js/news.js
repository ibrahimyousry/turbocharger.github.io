...
$(function () {
    ...
    $('.the-news .eac-news .news-cat .before-cat').width(($('.the-news .eac-news .news-cat').width() - $('.the-news .eac-news .news-cat .content').width() - 20) / 2);
    
    $('.the-news .eac-news .news-cat .after-cat').width(($('.the-news .eac-news .news-cat').width() - $('.the-news .eac-news .news-cat .content').width() - 20) / 2);
